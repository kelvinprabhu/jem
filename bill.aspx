<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="bill.aspx.vb" Inherits="JEM_MK.WebForm5" %>
  ...
  <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Author Name"></asp:TextBox>
                             ...
                             <div class="col-md-8">
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="bd" runat="server" placeholder="description"></asp:TextBox>
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="col-md-8">
                                <label>AMOUNT</label>
                                <div class="form-group">
                              <asp:TextBox Class="form-control" ID="TextBox8" runat="server" placeholder="description" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            </div>
