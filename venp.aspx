<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="venp.aspx.vb" Inherits="JEM_MK.WebForm20" %>
  ...
  <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Author Name"></asp:TextBox>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox9" runat="server" placeholder="Email ID" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
            ...
            <a href="ven.aspx"><< Back to Home</a><br><br>
         </div>
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
